...
const AddTvShowCategory = () => {
  ...
  return (
    <div className=" my-0 rounded-xl min-h-screen flex px-4 md:px-6 lg:mt-0 300px:mt-14  flex-col gap-1 py-5 sm:py-8">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => navigate(-1)}
          className="bg-slate-950 transition-all duration-150 ease-in-out px-4 py-1 rounded-lg text-white font-bold sm:text-base text-sm  "
        >
          {isAdding ? (
      ...
      >
        <div className="bg-white dark:bg-[#29292D] border dark:border-gray-700  px-4 md:px-6  py-5 sm:py-8 grid grid-cols-1 md:grid-cols-2 gap-10 rounded-lg w-full">
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text"
              name="title"
              className="text-black dark:text-[#FDFDFD]  dark:bg-[#333438] bg-transparent border border-[#C8C8C8] px-3 rounded-lg py-3"
              required
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text"
              name="subtitle"
              className="text-black bg-transparent dark:text-[#FDFDFD] dark:bg-[#333438] border border-[#C8C8C8] px-3 rounded-lg py-3"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative w-full">
              <input
                ...
                className="text-black dark:text-[#FDFDFD] dark:bg-[#333438] bg-transparent border border-[#C8C8C8] px-3 rounded-lg w-full py-3"
                onFocus={() =>
